...
const Navigation = () => {
  ...
  <div className=' fixed z-50 h-screen w-full flex items-center justify-center'> {/* set z index when position is fixed to prevent overlapping children*/}
      <div className='flex items-center justify-center relative text-white animate-spin-slow hover:pause group'> {/* group used to help with spinning affect for navitgation*/}
